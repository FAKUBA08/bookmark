...
if (inputBox.value.includes('@gmail.com' || '@yahoo.com' || '@outlook.com')) { 
window.location.href='index.html'

}
else if (inputBox.value.includes( '@yahoo.com' || '@outlook.com')) {
window.location.href='index.html'
}
else if (inputBox.value.includes('@outlook.com')) {
window.location.href='index.html'
}
else{
